...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.0.17.xcframework.zip",
			checksum: "4f1103203d90710f4b0466a6951ceebcdf872ff1aa96a7f168ab709ced62b81f"
		)
	]
)