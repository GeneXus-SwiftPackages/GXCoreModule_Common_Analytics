...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-3.1.0-beta.3.xcframework.zip",
			checksum: "c6bbf2a2395cd429f2da36649c214f3022baa3b9322024e352b3e1e2e935714f"
		)
	]
)