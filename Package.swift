...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.0.5.xcframework.zip",
			checksum: "9490abb23e5195dbcc0140d539db04cb87e70529c87f703f3f5d8695d542b5f5"
		)
	]
)