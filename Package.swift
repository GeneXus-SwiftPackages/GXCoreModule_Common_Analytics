...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.1.0.xcframework.zip",
			checksum: "5e01a46f3cd0190cdb0cbe4354400fdbd3bf19f0511fbdadd79c4b9e37c6c54b"
		)
	]
)