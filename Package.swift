...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.1.0.xcframework.zip",
			checksum: "d87d227f13d43dffedec87d207444910400d9789d6da0a3389539132616ff7f5"
		)
	]
)