...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-2.1.3.xcframework.zip",
			checksum: "0eb25db68af6355723b07ff4ddab2b145e72c693e7287c9f02fcd614fe2bd28d"
		)
	]
)