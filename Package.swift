...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.2.2.xcframework.zip",
			checksum: "08c53f4dedf27ddaf4b13ef47144fec75d6207959be8c50e7d01aadfefda360e"
		)
	]
)