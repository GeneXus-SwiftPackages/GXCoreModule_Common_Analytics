...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-1.2.0-beta.9.xcframework.zip",
			checksum: "f855a897cde8aa2cff460b32b5703f1f962668c9030463df16e25aee3755b39e"
		)
	]
)