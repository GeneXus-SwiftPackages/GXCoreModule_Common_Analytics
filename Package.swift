...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.4.30.xcframework.zip",
			checksum: "560c5394397245607533e636039ff056db2ffb8544e4d0d23ae2a8623e856fb2"
		)
	]
)