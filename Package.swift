...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.3.5.xcframework.zip",
			checksum: "9182c37c365d865ad97b91f48ee11249febffc2f3f9e9016e48ff422e2bed5c3"
		)
	]
)