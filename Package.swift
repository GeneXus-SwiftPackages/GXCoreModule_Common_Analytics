...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.4.29.xcframework.zip",
			checksum: "b5ba50038ff5eef0351594c9d6cbeddae69ad7113048429dbf4002bbb5d88929"
		)
	]
)