...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.1.1.xcframework.zip",
			checksum: "53986f329743dbd5e6a39877d4e4a559ecd4140ac60a44236f463c5cf5975182"
		)
	]
)