...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-2.0.0-beta.41.xcframework.zip",
			checksum: "6660330cbca88aa60c931123e5637d4e2b7ef2098fba71448da62cb35aef0780"
		)
	]
)