...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.0.7.xcframework.zip",
			checksum: "b563c7c92f75b1d4dc5d63ffa4f011701ddc0d87d11d24cc6563842220c9bc1b"
		)
	]
)