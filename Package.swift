...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-2.0.18.xcframework.zip",
			checksum: "49f327416830c4f52419a23ddfb1ced1b1bfcff565f897214c7f6fdaadafc66c"
		)
	]
)