...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Analytics-1.2.0-rc.1.xcframework.zip",
			checksum: "18c6ec83ee4dbffd61c2f42e6e1c0b2562d15df5698e198e8cb8fc48f67faefb"
		)
	]
)