...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.0.6.xcframework.zip",
			checksum: "f8553e7f2f9804c28ac83a67fd7b485962d6fc7f6a0ddd581d0913bad1993cb1"
		)
	]
)