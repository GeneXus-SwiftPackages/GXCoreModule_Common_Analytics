...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.2.0.xcframework.zip",
			checksum: "5e6d434980fde3f1859be452cc43d919f533aeac4578c09d2e67e7aed9164e35"
		)
	]
)