...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.2.0.xcframework.zip",
			checksum: "3ab39ddf4e8618d24f016690124654bd7db90c9c5b2f9dbc5d7c547c5168161c"
		)
	]
)