...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.5.12.xcframework.zip",
			checksum: "00acec35b0c378b434407b2568443b22e3e25be2dc3b3da7ffcd3297382d71c1"
		)
	]
)