...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Analytics-1.4.0-rc.21.xcframework.zip",
			checksum: "4ed5f44ab3e68ccf87fe4a35e3fcfbaee4fb6637eae7f125c50cc9a2ee6bf39e"
		)
	]
)