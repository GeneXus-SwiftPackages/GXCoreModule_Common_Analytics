...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.1.3.xcframework.zip",
			checksum: "cb9eb07db89a8cbc66ae82a9416ce10485c85fedc696991603077b283e1332e6"
		)
	]
)