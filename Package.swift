...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-3.0.0-beta.16.xcframework.zip",
			checksum: "30ba787a33c381fd4546c98a72249b9e8c2343073fa5271cbb9e565a74b29bb1"
		)
	]
)