...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Analytics-3.0.0-rc.15.xcframework.zip",
			checksum: "1e0cacece67348a7345a917cc0f125c08501f493cd627761dfc4e35144162cbd"
		)
	]
)