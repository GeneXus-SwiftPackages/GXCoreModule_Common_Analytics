...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-2.0.0-beta.18.xcframework.zip",
			checksum: "7cc5895afb90f317e705978989007677f64f5e46c185aabff81740407f7d84e9"
		)
	]
)