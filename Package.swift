...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.0.2.xcframework.zip",
			checksum: "abaf9ccc109001619ee170f4fcac9581ae76637c5b37f3d56f819fdcc1fddc5d"
		)
	]
)