...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.1.5.xcframework.zip",
			checksum: "1e017d6b27d275c658ef67cc8dddc50a00757b3cbeeb487b521fb912ff81f576"
		)
	]
)