...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-2.1.4.xcframework.zip",
			checksum: "9fb23390dffa7827b648380722e8850e21f517bbab2e18e683a25e3c957151cb"
		)
	]
)