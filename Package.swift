...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.0.2.xcframework.zip",
			checksum: "bf66e5daaf5c27f9f55bbcab770c38b1e8d87133c09c18284cab73f7d91aeddf"
		)
	]
)