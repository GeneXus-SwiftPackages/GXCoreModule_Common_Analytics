...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.5.16.xcframework.zip",
			checksum: "823d52b3c73ebdfe8805b8845fc5b037fecb8f39efd96f0905f2b45647762d77"
		)
	]
)