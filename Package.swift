...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.1.5.xcframework.zip",
			checksum: "774ddbf646d796eaca36aaa5d0e0f7c3b915cd035f56e0e44f364ebcc40f6113"
		)
	]
)