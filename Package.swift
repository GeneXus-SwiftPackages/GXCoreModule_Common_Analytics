...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.3.6.xcframework.zip",
			checksum: "05aa0f3b365e9e0875ffd1194921b3c4dffe87a7d1ce49eb2f2feb7ae729f7a0"
		)
	]
)