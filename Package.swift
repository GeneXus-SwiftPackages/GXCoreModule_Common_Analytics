...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.1.4.xcframework.zip",
			checksum: "57642b1ad72ea1b38d088d2655065061ec523dcc364196845c6c0d3ef5a96452"
		)
	]
)