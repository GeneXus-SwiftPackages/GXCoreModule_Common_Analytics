...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.4.31.xcframework.zip",
			checksum: "6d9c8616ce2e46cedff118095483d42e5ea3aaf634bc0081ed17946e1e1d0856"
		)
	]
)