...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.1.2.xcframework.zip",
			checksum: "17f8fb8b9c9582c777205167e622fe779d126b893da3b68ab9dcd56e214d6b70"
		)
	]
)