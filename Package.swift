...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.0.3.xcframework.zip",
			checksum: "659601f4023a8bd0db7f0d87087859fd6b6e3b390a69f162e10122598811901e"
		)
	]
)