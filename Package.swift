...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.4.26.xcframework.zip",
			checksum: "c94236a0633b8560d98113f3dbee915f5e5ef52d0c8252b4c44d1b4acc986f1a"
		)
	]
)