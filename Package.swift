...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Analytics-1.3.0-rc.13.xcframework.zip",
			checksum: "fa8a3b7054e17a9a241e347ece96ae219d60c29bee2f2558fc1a0728251b0f38"
		)
	]
)