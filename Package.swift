...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-4.1.0-beta.11.xcframework.zip",
			checksum: "784b1642c932a3c271d3c9761774a1362faf4211065f3a13a006e43ce5fa75e8"
		)
	]
)