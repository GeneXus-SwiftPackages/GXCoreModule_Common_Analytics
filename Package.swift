...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.1.2.xcframework.zip",
			checksum: "26ee95bb780ae52875c67a1b4085a0e168569284774e9b150bec33f1a87ffe79"
		)
	]
)