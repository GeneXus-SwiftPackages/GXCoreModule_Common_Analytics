...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-4.0.0.xcframework.zip",
			checksum: "739a99d648bde3e96e5306d5220766558a2cff7c3e1a73dd89629c6f274aa375"
		)
	]
)