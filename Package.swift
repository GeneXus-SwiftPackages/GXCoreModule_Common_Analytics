...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Analytics-1.6.0-rc.0.xcframework.zip",
			checksum: "5146952874018d3d7e0c9916fc281197dec2c9c96f9c9424683c333199787fb3"
		)
	]
)