...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.2.0.xcframework.zip",
			checksum: "a9c344339e6b666291c26890421e7f0094f9b6905777f98f252c1c8185cb338d"
		)
	]
)