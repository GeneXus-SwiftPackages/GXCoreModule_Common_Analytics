...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.1.1.xcframework.zip",
			checksum: "a92f015b38f1fe5be5643791aae717c25f5a1edd4869e15cc9a0414ad193b0cf"
		)
	]
)