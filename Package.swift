...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-3.0.7.xcframework.zip",
			checksum: "c180649c2616cf1a1de740e22a19a3e1caeab5146c17ad5b9c2b99ea24af1a7d"
		)
	]
)