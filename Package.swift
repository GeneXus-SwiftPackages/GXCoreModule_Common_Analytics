...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-1.4.0-beta.8.xcframework.zip",
			checksum: "b0f566bde60e9310f48e225a5147d92ffcf9379afa3881dbb64286c347a637d3"
		)
	]
)