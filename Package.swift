...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_Common_Analytics-2.0.0-rc.22.xcframework.zip",
			checksum: "19015cc5dbfba50a1fabbf834926bc4dbd8a9383a9e63397e73cfebb8d14619d"
		)
	]
)