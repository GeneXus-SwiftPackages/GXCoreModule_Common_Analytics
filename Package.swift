...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_Common_Analytics-1.5.0-beta.8.xcframework.zip",
			checksum: "8b9b7909697233603f37b7571c53534513b8208617e0feec02d8dace21a81393"
		)
	]
)