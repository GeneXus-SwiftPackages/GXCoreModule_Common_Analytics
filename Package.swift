...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.3.0.xcframework.zip",
			checksum: "93770908316520c47b657c974689ae0eb8d3e109a4b76a068ca271330885405f"
		)
	]
)