...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_Common_Analytics",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_Common_Analytics-1.1.0-rc.1.xcframework.zip",
			checksum: "408edc0863d983b01fe14bbfc08220fef67efc474fd25f1b06d3967cf52be508"
		)
	]
)